...
Backend download (required): \
Linux backend status: uploaded (https://drive.google.com/file/d/16GQC0LKV9gtiCXF_H9vdoX7hMMfjyoZM/view?usp=sharing) \
Windows backend status: in this github (bc google called my innocent backend "malware") \
note: for windows backend also get the dll files, duh.
